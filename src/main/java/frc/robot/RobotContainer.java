...
public class RobotContainer {
  ...
  // Touchboard
  private final ActionButton Shoot = new ActionButton("testingbutton", m_ShootCommand);
  private final ActionButton Deposit = new ActionButton("testingbutton2", m_algaeProcessorDepositCommand);
  private final DoubleActionButton Intake = new DoubleActionButton("testingbutton3", m_algaeIntakeCommand, algae.allMotorsOFFCommand());
  private final DoubleActionButton ArmUp = new DoubleActionButton("testingbutton4", arm.armManualUpCommand(), arm.armStopCommand());
  private final DoubleActionButton ArmDown = new DoubleActionButton("testingbutton5", arm.armManualDownCommand(), arm.armStopCommand());
  ...
  public RobotContainer() {
    ...
    algaeIntakeButton = new JoystickButton(buttonBoard, 3);//add wait until arm position
